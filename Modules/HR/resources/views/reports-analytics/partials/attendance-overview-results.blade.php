        ...
        <tbody>
            @forelse($employees as $employee)
                <tr class="border-t border-white/[0.18] transition-colors duration-[250ms] hover:bg-[#21457f]">
                    ...
                    <td class="p-4 text-[0.84375rem] text-center border-r border-white/[0.12] font-extralight w-[14%]">{{ $employee->department }}</td>
                    ...
                    <td class="p-4 text-[0.84375rem] text-center font-extralight w-[10%]">
