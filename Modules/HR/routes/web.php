...
Route::middleware('hr.access')->group(function () {
    ...
    Route::get('/employee-dashboard', [DashboardController::class, 'employeeIndex'])->name('hr.employee.dashboard');
    Route::post('/logout', function () {
        session()->forget(['employee_logged_in', 'employee_role', 'employee_id', 'employee_name', 'employee_email', 'employee_department']);
    ...
    Route::get('/reports-analytics/attendance-overview', [ReportsAnalyticsController::class, 'index'])->name('reports-analytics.attendance-overview');
    Route::get('/reports-analytics/employee-attendance/{employee}', [ReportsAnalyticsController::class, 'employeeAttendance'])->name('reports-analytics.employee-attendance');
    Route::get('/reports-analytics/leave', [ReportsAnalyticsController::class, 'leave'])->name('reports-analytics.leave');
    Route::get('/clockinout', fn () => view('clockinout.index'))->name('clockinout');
    Route::post('/clock-in', [AttendanceController::class, 'clockIn'])->name('clockinout.index');
});
