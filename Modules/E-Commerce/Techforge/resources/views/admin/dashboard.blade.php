...
<section class="card" style="margin-top:20px">
    <div style="display:flex;justify-content:space-between;align-items:center;gap:16px"><h2>Recent listings</h2><a class="button" href="{{ route('ecommerce.admin.listings.create') }}">+ Add listing</a></div>
