...
Route::get('/account/profile', function () {
    return view('ecommerce::account.index', [
        'paymentMethods' => \Illuminate\Support\Facades\Auth::guard('ecommerce')->check() ? \Illuminate\Support\Facades\Auth::guard('ecommerce')->user()->paymentMethods()->orderBy('is_default', 'desc')->get() : []
    ]);
...
Route::post('/account/payment-methods/{paymentMethod}/update', [\Modules\Ecommerce\Http\Controllers\PaymentMethodController::class, 'update'])->name('account.payment-methods.update');
